    ...
    def asCollection(cardData: Collection): Collection = {
      ...
      Collection(
        ...
        propertyValues = Map(
          ...
          EditionProperties.illustrator -> PropertyValue(textValues = edition.illustrator ++: Nil),
          ...
          EditionProperties.effect -> PropertyValue(textValues = edition.effect ++: Nil),
          EditionProperties.effectRaw -> PropertyValue(textValues = edition.effect_raw ++: Nil),
          EditionProperties.flavourText -> PropertyValue(textValues = edition.flavor ++: Nil),
          EditionProperties.configuration -> PropertyValue(textValues = edition.configuration ++: Nil),
          EditionProperties.orientation -> PropertyValue(textValues = edition.orientation ++: Nil),
        )
      )
    }
