...
class Fixtures()(implicit session: DBSession):
  ...
  val shortProperty = ProjectedProperty(propertyName = "short", propertyTypes = List(short))
  val intProperty: ProjectedProperty = ProjectedProperty(propertyName = "int", propertyTypes = List(int))
  val longProperty = ProjectedProperty(propertyName = "long", propertyTypes = List(long))
  ...
  val allProperties = Seq(
    textProperty, bytesProperty, shortProperty, intProperty, longProperty, floatProperty,
  ...
  val childAofRootA = ProjectedCollection(propertyValues = Map(
    textProperty -> ProjectedPropertyValue(stringValues = List("1")),
    bytesProperty -> ProjectedPropertyValue(byteValues = List("1".getBytes)),
    shortProperty -> ProjectedPropertyValue(shortValues = List(1.toShort)),
    intProperty -> ProjectedPropertyValue(intValues = List(1)),
    longProperty -> ProjectedPropertyValue(longValues = List(1L),
    ...
    compositeProperty -> ProjectedPropertyValue(stringValues = List("1"), intValues = List(1))
  ))
  val childBofRootA = ProjectedCollection(propertyValues = Map(
    textProperty -> ProjectedPropertyValue(stringValues = List("2")),
    bytesProperty -> ProjectedPropertyValue(byteValues = List("2".getBytes)),
    shortProperty -> ProjectedPropertyValue(shortValues = List(2.toShort)),
    intProperty -> ProjectedPropertyValue(intValues = List(2)),
    longProperty -> ProjectedPropertyValue(longValues = List(2L)),
    ...
    compositeProperty -> ProjectedPropertyValue(stringValues = List("2"), intValues = List(2))
  ))
  val childCofRootA = ProjectedCollection(propertyValues = Map(
    textProperty -> ProjectedPropertyValue(stringValues = List("3")),
    bytesProperty -> ProjectedPropertyValue(byteValues = List("3".getBytes)),
    shortProperty -> ProjectedPropertyValue(shortValues = List(3.toShort)),
    intProperty -> ProjectedPropertyValue(intValues = List(3)),
    longProperty -> ProjectedPropertyValue(longValues = List(3L)),
    ...
    compositeProperty -> ProjectedPropertyValue(stringValues = List("3"), intValues = List(3))
  ))
  val rootB = ProjectedCollection()
  val childAofRootB = ProjectedCollection(propertyValues = Map(
    textProperty -> ProjectedPropertyValue(stringValues = List("4")),
    bytesProperty -> ProjectedPropertyValue(byteValues = List("4".getBytes)),
    shortProperty -> ProjectedPropertyValue(shortValues = List(4.toShort)),
    intProperty -> ProjectedPropertyValue(intValues = List(4)),
    longProperty -> ProjectedPropertyValue(longValues = List(4L)),
    ...
    compositeProperty -> ProjectedPropertyValue(stringValues = List("4"), intValues = List(4))
  ))
  val childBofRootB = ProjectedCollection(propertyValues = Map(
    textProperty -> ProjectedPropertyValue(stringValues = List("5")),
    bytesProperty -> ProjectedPropertyValue(byteValues = List("5".getBytes)),
    shortProperty -> ProjectedPropertyValue(shortValues = List(5.toShort)),
    intProperty -> ProjectedPropertyValue(intValues = List(5)),
    longProperty -> ProjectedPropertyValue(longValues = List(5L)),
    ...
    compositeProperty -> ProjectedPropertyValue(stringValues = List("5"), intValues = List(5))
  ))
  val childCofRootB = ProjectedCollection(propertyValues = Map(
    textProperty -> ProjectedPropertyValue(stringValues = List("6")),
    bytesProperty -> ProjectedPropertyValue(byteValues = List("6".getBytes)),
    shortProperty -> ProjectedPropertyValue(shortValues = List(6.toShort)),
    intProperty -> ProjectedPropertyValue(intValues = List(6)),
    longProperty -> ProjectedPropertyValue(longValues = List(6L)),
    ...
    compositeProperty -> ProjectedPropertyValue(stringValues = List("6"), intValues = List(6))
  ))
  val rootC = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "rootC":: Nil)))
  val childAofRootC = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "childAofRootC":: Nil)))
  val child1OfChildA = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "child1OfChildA":: Nil)))
  val child2OfChildA = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "child2OfChildA":: Nil)))
  val childXofChild1 = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "childXofChild1":: Nil)))
  val childYofChild1 = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "childYofChild1":: Nil)))
  val childXofChild2 = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "childXofChild2":: Nil)))
  val childYofChild2 = ProjectedCollection(propertyValues = Map(textProperty -> ProjectedPropertyValue(stringValues = "childYofChild2":: Nil)))
